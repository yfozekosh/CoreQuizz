...
{
    public class RadioQuestionDispatcher : EfQuestionDispatcher<RadioQuestion>
    {
        public RadioQuestionDispatcher(SurveyContext surveyContext) : base(surveyContext)
        {
        }
        ...
        public override async Task<CommandResult> DeleteAsync(Survey survey, RadioQuestion question)
        {
            if (question == null) throw new ArgumentNullException(nameof(question));
            RadioQuestion dbQuestion = SurveyContext.Find<RadioQuestion>(question.Id);
